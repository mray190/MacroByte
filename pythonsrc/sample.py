...
def start_sandbox(argv):
    mirr_word = mirror_word("hello there!".upper())
    pig_lat_enc = pig_latin_enc_phrase("Hello there")
    pig_lat_dec = pig_latin_dec_phrase(pig_lat_enc)
